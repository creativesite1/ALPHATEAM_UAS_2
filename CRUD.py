...
app.server.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://postgres:postgres_admin@localhost/test"
app.layout = html.Div([
    html.Div([
        dcc.Input(
            id='adding-rows-name',
    ...
    dash_table.DataTable(
        id='our-table',
        columns=[{'name': 'id', 'id': 'Product', 'deletable': False, 'renamable': False},
                 {'name': 'brand', 'id': 'Version', 'deletable': True, 'renamable': True},
                 {'name': 'model', 'id': 'Price', 'deletable': True, 'renamable': True},
                 {'name': 'price', 'id': 'Sales', 'deletable': False, 'renamable': False}],
        data=[{'Product': '1', 'Version': 'Honda', 'Price': 'Accord','Sales':'150'}],
